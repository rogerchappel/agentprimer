...
Replace this section with the supported versions for `agentprimer`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `agentprimer` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in agentprimer.
